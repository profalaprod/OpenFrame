...
async function sendEmail(to: string, subject: string, html: string): Promise<boolean> {
  ...
  const fromAddress =
    process.env.SMTP_FROM || process.env.EMAIL_FROM || 'FRAME <contact@ndongala.tech>';
...
function formatEmail(
  ...
  switch (event.type) {
    case 'new_video':
      return {
        subject: `[FRAME] New video in ${event.projectName}: ${event.videoTitle}`,
        html: emailTemplate(`
    ...
    case 'new_version':
      return {
        subject: `[FRAME] New version of ${event.videoTitle} in ${event.projectName}`,
        html: emailTemplate(`
    ...
    case 'new_comment':
      return {
        subject: `[FRAME] New comment on ${event.videoTitle}`,
        html: emailTemplate(`
    ...
    case 'new_reply':
      return {
        subject: `[FRAME] ${event.replyAuthor} replied on ${event.videoTitle}`,
        html: emailTemplate(`
    ...
    case 'approval_requested':
      return {
        subject: `[FRAME] Approval requested for ${event.versionLabel} in ${event.projectName}`,
        html: emailTemplate(`
    ...
    case 'approval_action':
      return {
        subject: `[FRAME] Approval ${event.action} by ${event.actorName}`,
        html: emailTemplate(`
    ...
    case 'approval_completed':
      return {
        subject: `[FRAME] Approval completed for ${event.versionLabel}`,
        html: emailTemplate(`
    ...
    case 'approval_rejected':
      return {
        subject: `[FRAME] Approval rejected by ${event.rejectedBy}`,
        html: emailTemplate(`
